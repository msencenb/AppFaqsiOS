...
Pod::Spec.new do |s|
  s.name             = "AppFaqs"
  s.version          = "0.1.0"
  s.summary          = "A short description of AppFaqs."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/AppFaqs"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Matt Sencenbaugh" => "matt.sencenbaugh@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/AppFaqs.git", :tag => s.version.to_s }
